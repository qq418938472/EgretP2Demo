class Tools {
    ...
    */
    ...
    public static btnAddAnimation(imgArr: Array<any>) {
    ...
    public static onFlash(obj: any, isStop?: boolean): void {
        if (isStop) {
    ...
    */
    ...
    public static setColorMatrix(obj) {
        var colorMatrix = [
            0.3, 0.6, 0, 0, 0,
            0.3, 0.6, 0, 0, 0,
            0.3, 0.6, 0, 0, 0,
    ...
    public static getNumWord(num: number) {
        var text: string;
        if (num > 100000000) {
